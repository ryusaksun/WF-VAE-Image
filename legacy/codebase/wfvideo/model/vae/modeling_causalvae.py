...
from wfimagevae.model.modules import Normalize
from wfimagevae.model.modules.ops import nonlinearity
from wfimagevae.model.utils.module_utils import resolve_str_to_obj, Module
from wfimagevae.model.utils.distrib_utils import DiagonalGaussianDistribution
from wfimagevae.model.registry import ModelRegistry
from wfimagevae.model.modeling_output import AutoencoderKLOutput, DecoderOutput, ForwardOutput
...
class CausalVAEModel(VideoBaseAE):
    ...
    def __init__(
        ...
        self.tile_sample_min_size_t = 9
        self.tile_latent_min_size_t = 3
    ...
    def forward(self, input, sample_posterior=True):
        ...
        return ForwardOutput(sample=dec, latent_dist=posterior)
