...
import safetensors
sys.path.append(".")
from legacy.codebase.wfvideo.model.vae.modeling_causalvae import CausalVAEModel

origin_ckpt_path = "/remote-home1/lzj/sd_vae.ckpt"
config_path = "models/sd3_vae/config.json"
output_path = "models/sd3_vae_inflate"
init_method = "tail"
